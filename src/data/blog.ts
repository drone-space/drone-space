  ...
  },
  {
    ...
    desc: {
      ...
      list: [
        ...
        {
          title:
            'Sustainable Land Governance and Climate Change - The Perfect Stage',
  ...
  },
  {
    ...
    desc: {
      p: [
        ...
        "As the energy sector continues to evolve and expand, the partnership between KenGen and Drone Space Kenya remains a shining example of how innovative technology and high-quality training can drive the industry forward. With the skills acquired in our training programs, KenGen's professionals are ready to embrace the future with open arms and take Kenya’s Energy sector to new heights.",
      ],
      list: [
        {
