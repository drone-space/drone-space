...
export default function Advertisment({ active }: { active?: boolean }) {
	...
	const dataMobile = [{ title: "August Intake", image: images.posters.intakes.yr2024.jul.portrait }];

	const data = [{ title: "August Intake", image: images.posters.intakes.yr2024.jul.portrait }];
