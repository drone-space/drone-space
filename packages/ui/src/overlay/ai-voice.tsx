          ...
          >
            <Center h={'100%'}>
              <Stack align="center" gap={SECTION_SPACING / 3}>
                ...
                <IndicatorAudio
                  props={{
                    volumeRef: props.listening ? props.volumeSTT : props.volumeTTS,
                    size: { height: 56, width: 3 },
                  }}
                />

                <Group justify="center">
                  <Tooltip label={listeningProps.label} fz={'xs'} color="pri" withArrow>
                    <ActionIcon
                    ...
                    >
                      <listeningProps.icon size={ICON_SIZE} stroke={ICON_STROKE_WIDTH * 1.5} />
                    </ActionIcon>
                  </Tooltip>
                  ...
                  <Tooltip label={'End'} fz={'xs'} color="pri" withArrow>
                    ...
                    >
                      <IconX size={ICON_SIZE * 1} stroke={ICON_STROKE_WIDTH * 2} />
                    </ActionIcon>
                  </Tooltip>
                </Group>
              </Stack>
