...
import { CardQuestionWithAnswer } from '@repo/ui';
import { LayoutIntroSection } from '@repo/ui';
import { APPSHELL } from '@learn/ui/layout/appshell/student';
              ...
              <Stack gap={SECTION_SPACING}>
                {quizQuestionsQuizQuestions.map((qqqqi, i) => {
                  ...
                  const userAnswer = attemptAnswers?.find((aa) => {
                    const option = options?.find((o) => o.id == aa.optionId);
                    return option?.questionId == qqqqi.id;
                  });
