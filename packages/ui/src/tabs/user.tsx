        ...
        >
          {tabs.map((tt) => (
            <TabsTab
              key={tt.label}
              value={tt.value}
              leftSection={<tt.icon size={ICON_SIZE} stroke={ICON_STROKE_WIDTH} />}
              styles={{
                tab: { padding: '8px 8px' },
    ...
    <>
      <Group justify="space-between">
        ...
        <Select
          ...
          data={themes}
          value={colorScheme}
          onChange={(value) => startTransition(() => setColorScheme(value as MantineColorScheme))}
        />
      </Group>
  ...
  return (
    ...
    >
      <Stack gap={'xs'}>
        ...
        <Transition mounted={form.isDirty()} transition="fade" duration={400} timingFunction="ease">
          {(styles) => (
            <div style={styles}>
              <Box mt={'md'}>
                <Divider mb={'xs'} />
    ...
    <>
      ...
      <Group justify="space-between">
        ...
        <Button
          ...
          color="red.6"
          variant="light"
          leftSection={<IconTrash size={ICON_SIZE - 6} stroke={ICON_STROKE_WIDTH} />}
        >
          Delete
        </Button>
      </Group>
    ...
    <>
      ...
      <Group justify="space-between">
        ...
        <Button
          ...
          leftSection={<IconLogout2 size={ICON_SIZE - 6} stroke={ICON_STROKE_WIDTH} />}
        >
          Log out
        </Button>
      </Group>
      ...
      <Group justify="space-between">
        ...
        <TooltipDisabled>
          <Button
            ...
            variant="light"
            disabled
            leftSection={<IconAlertTriangle size={ICON_SIZE - 6} stroke={ICON_STROKE_WIDTH} />}
          >
            Delete
          </Button>
        </TooltipDisabled>
