import { Anchor, Badge, Card, CardSection, Image, Stack, Text, Title } from "@mantine/core";
...
export default function Course({ data, type }: { data: typeUnit; type: "basic" | "advanced" }) {
	return (
		<Card className={classes.card}>
			<Stack>
				<CardSection>
					<Anchor component={Link} href={`/training/${type}/${link.linkify(data.title.full)}`}>
