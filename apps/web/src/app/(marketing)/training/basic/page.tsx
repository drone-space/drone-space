...
export default async function Basic() {
  return (
    <LayoutPage>
            ...
            <Stack gap={'xs'}>
              ...
              <Stack>
                <Text>
                  ...
                  however, drone space offers only two categories:
                </Text>
                <List
                  listStyleType="none"
                  withPadding={true}
      ...
      <LayoutSection id="page-basic-rpl" padded containerized={'responsive'}>
        <Stack gap={'xl'}>
          <Stack gap={'xs'}>
            <Title
              ta={'center'}
