              ...
              <LayoutSection id={`carousel-home-slide-${index}`} pt={'lg'} pb={'md'}>
                ...
                >
                  ...
                  <Group>
                    ...
                    {!complete && (
                      <AnchorNextLink href="/drone-solutions/light-shows/drone-light-show-challenge">
                        <Button color="white" variant="outline">
