      ...
      <LayoutSection id="our-story" padded bg={'var(--mantine-color-gray-1)'}>
        <Grid gap={'xl'}>
          <GridCol span={{ base: 12, md: 6, lg: 6.5 }} order={{ base: 2, md: 1 }}>
            ...
            <Text pr={{ md: 'md' }} mt={'xl'}>
              {COMPANY_NAME} is an authorized provider of the following ratings for your Remote
              Pilot License (RPL) and more than one rating can be obtained:
            </Text>

            {ratings.map((item, index) => (
              <Group key={index} gap={'xs'} wrap="nowrap" align="start" pl={{ md: 'md' }} mt={'md'}>
            ...
            <Text mt={'xl'}>Besides these ratings, we offer specialized training in:</Text>
          ...
          <GridCol span={{ base: 12, md: 6, lg: 5.5 }} order={{ base: 1, md: 2 }}>
            <ImageDefault
              src={'https://cdn.pixabay.com/photo/2022/07/07/17/37/dji-7307627_1280.jpg'}
