...
import { Modal, Grid, GridCol, Stack, Image, Text, Group, NumberFormatter, Button, Title } from "@mantine/core";
import { useDisclosure, useMediaQuery } from "@mantine/hooks";

import { IconArrowRight, IconSchool } from "@tabler/icons-react";

import CounterIntakeModal from "@/partials/counter/intake/Modal";
...
export default function Pricing({ children, data }: { children: React.ReactNode; data: typeUnit }) {
					...
					<GridCol span={{ base: 12, sm: 6 }}>
						<Stack gap={"md"} justify="space-between" h={"100%"}>
							...
							<Group align="end" justify="space-between">
								<CounterIntakeModal dates={dates.intakes} />

								<ModalContactTraining>
									<Button
										size="xs"
										leftSection={<IconSchool size={16} stroke={1.5} style={{ marginTop: 2 }} />}
									>
