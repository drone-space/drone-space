...
export const quizQuestionsGet = (params: { apiUrl: string; userId?: string }) => {
...
export const quizQuestionGet = (params: { apiUrl: string; quizQuestionId: string }) => {
  return apiCall(segment + `/${params.quizQuestionId}`, 'GET', params.apiUrl);
};

export const quizQuestionCreate = (apiUrl: string, quizQuestion: QuizQuestionCreate) => {
  return apiCall(segment + '/create', 'POST', apiUrl, quizQuestion);
};

export const quizQuestionUpdate = (apiUrl: string, quizQuestion: QuizQuestionUpdate) => {
