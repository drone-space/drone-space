...
export function LayoutBodyAI({
  ...
  const { targetRef, scrollableRef } = useScrollIntoView<HTMLDivElement, HTMLDivElement>();
      ...
      >
        ...
        <Group gap={5} className={classes.assistantActions}>
          <Tooltip label="Copy" withArrow fz={'xs'} color="pri">
            ...
            >
              <clipIndicators.icon size={ICON_SIZE / 1.25} stroke={ICON_STROKE_WIDTH} />
            </ActionIcon>
          </Tooltip>
