...
export const metadata: Metadata = { title: 'Advanced Training' };
...
export default async function Advanced() {
  return (
    <LayoutPage>
        ...
        <Grid gutter={{ base: 32, lg: 64 }}>
          <GridCol span={{ md: 6 }}>
            <Stack gap={'xs'}>
              ...
              <Stack>
                <Text>
                  There are Four categories that are under the RPL Training
                  however, drone space offers only three categories:
                </Text>
                <List
                  listStyleType="none"
                  withPadding={true}
          ...
          <GridCol span={{ md: 6 }} visibleFrom="md">
            ...
            >
              ...
              <GridCol span={{ md: 6 }}>
                <Stack>
                  <Image
                    src={courses.basic.units[2].image}
                    alt={'Gallery Image'}
                    loading="lazy"
                    // h={{ base: "100%", md: 200, lg: "100%" }}
        ...
        <Grid gutter={{ base: 32, lg: 64 }}>
          <GridCol span={{ md: 6 }} order={{ md: 2 }}>
            <Stack gap={'xs'}>
              ...
              <Text>
                The course duration is dependent on the amount of time you can
                commit to studying each week. However, it&apos;s important to
                note that the course is designed to be comprehensive and
                provides all the information you need to successfully complete
                the Remote Pilot License (RPL) exam. With a mix of video lessons
                and online quizzes, you&apos;ll have the opportunity to learn at
                your own pace and retain the information effectively. Whether
                you are a busy professional, a student or just someone looking
                to advance their career, our online class provides you with the
        ...
        <Grid gutter={{ base: 32, lg: 64 }}>
          <GridCol span={{ md: 6 }}>
            <Stack gap={'xs'}>
              ...
              <Text>
                Upon completion of the online course, students are required to
                sit for exams at any of our training centers after which they
                receive face to face practical flight instruction at our
                Airfield in Sigona. By obtaining an RPL, you will be able to
                legally operate drones in Kenya and potentially pursue a career
                in various industries, including cinematography, agriculture,
      ...
      <LayoutSection id="courses-rpl" padded containerized={'responsive'}>
        <Stack gap={'xl'}>
          <Stack gap={'xs'}>
            <Title
              ta={'center'}
