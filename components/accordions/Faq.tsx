		...
		training: [
			{
				...
				a: (
					<Text fz={"sm"}>
						The average completion time for the RPL courses is just under 2 weeks depending on personal
						schedule.
					</Text>
				),
			},
			{
				...
				a: (
					<List size="sm" pr={"md"}>
						...
						<ListItem>RPAS crews, pilots, ground control operators and maintainers Regulators</ListItem>
						<ListItem>
							Multi-agency teams, company managers, procurement officers or Safety System Managers
						</ListItem>
						<ListItem>Persons interested in mitigating RPAS human factors in BVLOS operations</ListItem>
					</List>
				),
			},
			{
				...
				a: (
					<Text fz={"sm"}>
						The aircraft needs to be registered with the KCAA under our training organisation in order for
						flight time to be logged, therefore it is not necessary to bring your own drone for training
						purposes.
					</Text>
				),
			},
			{
				...
				a: (
					<List size="sm" pr={"md"}>
						...
						<ListItem>
							Drone Space Instructors have the most experience in both Manned aviation and BVLOS
							Operations
						</ListItem>
						<ListItem>
						...
						<ListItem>
							Drone Space is practical and gives you tools to operate and get experience while developing
							a compelling safety case
						</ListItem>
					</List>
				),
			},
		...
		general: [
			{
				...
				a: (
					<Text fz={"sm"}>
						The RPL license forms part of the RPAS Operators Certification. However, an RPL alone would not
						qualify you to run a legal commercial operation. We may assist with the ROC consultation
						process.
					</Text>
				),
			},
			{
				...
				a: (
					<List size="sm" pr={"md"}>
						...
						<ListItem>
							The drone shall not be flown within a 10km radius of any airport or aerodrome
						</ListItem>
						<ListItem>
							The drone shall not be flown higher than 400ft above ground level and 500 metres in distance
			...
			},
			{
				...
				a: (
					<Text fz={"sm"}>
						Drone insurance requires the pilot to hold an RPL, the drone to be registered with KCAA and the
						flight to be conducted under an ROC.
					</Text>
				),
			},
			{
